...
set(handles.direction, 'String', ['R-F-U';'F-R-D';'F-U-R';'F-L-U']);
set(handles.axisselect, 'String', ['GyroX';'GyroY';'GyroZ';'AccX ';'AccY ';'AccZ ']);
set(handles.gyrounit, 'String', ['rad  ';'deg  ';'rad/s';'deg/s']); set(handles.gyrounit, 'Value', setting.gyrounit);
set(handles.accunit, 'String', ['m/s ';'g0*s';'m/ss';'g0  ']); set(handles.accunit, 'Value', setting.accunit);
dd = [];
...
global setting
k0 = find(t>=setting.t0, 1); k1 = find(t>=setting.t1, 1);
...
if unit==1, gyrounit=1; elseif unit==2, gyrounit=pi/180; elseif unit==3, gyrounit=ts; elseif unit==4, gyrounit=ts*pi/180; end 
unit = setting.accunit;
if unit==1, accunit=1; elseif unit==2, accunit=setting.g0; elseif unit==3, accunit=ts; elseif unit==4, accunit=ts*setting.g0; end 
for k=1:6
...
att = aligni0(setting.imu(k0:k1,:), pos);
